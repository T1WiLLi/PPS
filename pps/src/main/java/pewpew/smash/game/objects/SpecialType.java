...
public enum SpecialType {
    ...
    SCOPE_X2(0.75f, "Zoom Level 2", "Increases field of view by 2x."),
    SCOPE_X3(0.50f, "Zoom Level 3", "Increases field of view by 4x."),
    SCOPE_X4(0.25f, "Zoom Level 4", "Increases field of view by 8x.");
