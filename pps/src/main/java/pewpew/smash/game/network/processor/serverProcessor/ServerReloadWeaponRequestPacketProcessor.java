...
public class ServerReloadWeaponRequestPacketProcessor extends ServerProcessor
        implements PacketProcessor<ReloadWeaponRequestPacket> {

    public ServerReloadWeaponRequestPacketProcessor(EntityManager entityManager, ServerWrapper server) {
        super(entityManager, server);
    }

    @Override
    public void handle(Connection connection, ReloadWeaponRequestPacket packet) {
